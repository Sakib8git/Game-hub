...
export default function Footer() {
  return (
    <footer className="w-full bg-gray-900 text-gray-300">
      <div className="max-w-7xl mx-auto px-6 py-10 grid grid-cols-1 md:grid-cols-3 gap-8 items-start text-center md:text-left">
        
        <div className="flex flex-col items-center md:items-start">
          <div className="flex items-center gap-2 text-2xl font-bold text-white mb-3">
            <span className="fontStyle">Ga</span>
            <img src={logo} alt="logo" className="w-8 h-8" />
            <span className="fontStyle">E-HUB</span>
          </div>
